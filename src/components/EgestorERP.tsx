...
const EgestorERP = () => {
  ...
  const egestorLink = "https://www.egestor.com.br/afl/13300";

  return <section className="py-12 md:py-16 bg-white overflow-hidden">
      <div className="container px-4 mx-auto max-w-6xl">
        {/* Two-column layout for desktop, stack on mobile */}
        <div className="flex flex-col md:flex-row md:items-center md:gap-6 lg:gap-8 xl:gap-12 mb-8 md:mb-10">
          ...
          <div className="md:w-1/2 text-center md:text-left mb-6 md:mb-0 animate-fade-in">
            <a href={egestorLink} target="_blank" rel="noopener noreferrer" className="inline-block hover:opacity-90 transition-opacity">
              <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 mb-3 md:mb-4 leading-tight px-2 sm:px-0">Sistema de gestão empresarial</h2>
            </a>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 font-normal px-4 sm:px-0">
        ...
        <div className="flex justify-center animate-fade-in px-4 sm:px-0">
          <a href={egestorLink} target="_blank" rel="noopener noreferrer" className="inline-block w-full max-w-xs sm:max-w-sm">
            <button className="w-full py-3 md:py-4 bg-[#7CFFA0] hover:bg-[#6DF090] text-black font-medium text-base md:text-lg rounded-full transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]">
              Teste grátis
            </button>
          </a>
        </div>
