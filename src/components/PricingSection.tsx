      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-16">
            ...
            return <div key={index} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-border" style={{
          ...
          <div className="bg-gradient-hero rounded-3xl p-8 md:p-12 text-center text-white">
            <h3 className="text-3xl md:text-4xl font-bold font-heading mb-6 text-zinc-950">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button onClick={() => window.open('https://wa.me/5562984092737', '_blank')} size="lg" className="btn-hero px-8 py-4 text-lg flex items-center justify-center">
                <img src="/lovable-uploads/8edf1f78-0d2a-48d0-9215-136645befd25.png" alt="WhatsApp" className="h-5 w-5 mr-2" />
                Solicitar Consultoria
              </Button>
              <Button onClick={() => window.location.href = 'mailto:marcelo.meacontabilidade@gmail.com'} size="lg" variant="outline" className="btn-outline px-8 py-4 text-lg flex items-center justify-center">
