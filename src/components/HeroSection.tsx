    ...
    <section id="home" className="min-h-screen flex items-center gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          {/* Título principal */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-heading mb-6 fade-in-up" style={{ animationDelay: '0.2s' }}>
            SAS CONTABILIDADE
          </h1>
          
          {/* Slogan */}
          <p className="text-xl md:text-2xl font-medium mb-8 text-white/90 fade-in-up" style={{ animationDelay: '0.4s' }}>
            Sua contabilidade perto de você...
          </p>

          {/* Descrição */}
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-12 text-white/80 leading-relaxed fade-in-up" style={{ animationDelay: '0.6s' }}>
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 fade-in-up" style={{ animationDelay: '0.8s' }}>
            <Button 
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto fade-in-up" style={{ animationDelay: '1s' }}>
